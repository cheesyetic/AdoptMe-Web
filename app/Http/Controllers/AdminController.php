...
class AdminController extends Controller
{
    ...
    {
        $user = Auth::user();
        $User = User::where('role', '=', 'a')->get();
        return view('admin.index', ['User' => $User], compact('user'));
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.show', ['User' => $User], compact ('User'));
    }
    ...
    public function edit()
    {
        ...
        $id=Auth::user()->IDUser;
        $User= User::where('IDUser', $id)->first();
        return view('admin.edit', ['User' => $User], compact ('User'));
    }
    ...
    public function update(Request $request)
    {
        ...
        if($request->hasFile('User_Photo')){
            ...
            return redirect('/admprofile')->with('success','Product updated successfully!');
    }
    ...
    public function destroy($id)
    {
        $User= User::where('IDUser', $id)->first();
        $User->delete();        
        return redirect('/viewadmin')->with('success','Admin deleted successfully!');
    }
}
