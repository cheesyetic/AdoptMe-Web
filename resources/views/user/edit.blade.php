...
<link rel="stylesheet" href="{{asset('css/user-edit-profile.css')}}">
@endsection
...
@endif
    ...
    <div id="container">
        <form class="box-right-default flex-column" action="{{ route('updateprofileuser') }}" method="POST" enctype="multipart/form-data" id="box-right">
        @csrf
        @method('PUT')
            ...
            <div class="flex-row center" id="doubel-button">
                <center><button class="poppins" type="button" id="back" onclick="window.location='{{ url("/home") }}'">Cancel</button>
