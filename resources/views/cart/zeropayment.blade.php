...
<div class="container">
    ...
    <div class="box-content">
        <div class="payment_notif">
            ...
            <p><span style="color: red;">Total harga yang harus dibayar adalah Rp. 0</span></p>
        </div>
            ...
            <form class="sirclo-form" action="{{ route('confirm') }}" method="POST" enctype="multipart/form-data" autocomplete="off" id="payment-form">
                ...
                <div class="form-row">
                    <div class="col-md-5 mb-3">
                        ...
                        <input type="text" class="form-control" id="name" readonly value="Tidak ada yang harus dibayarkan ^^" required>
