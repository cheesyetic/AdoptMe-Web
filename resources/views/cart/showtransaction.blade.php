...
@section('container')
    <nav class="navbar navbar-light" style="background-color: #FFCC92;">
        <!-- Brand -->
        <a class="btn btn-outline-secondary navbar-brand" href="{{ route('viewtransaction') }}">Back</a>
    </nav>

    <div class="container-fluid">
        <h5 style="padding-top:4px; margin-bottom: (spacer * .25) !important;">SHOW TRANSACTION DETAILS</h5>
    ...
    <form>
        ...
        <div class="form-group row col-md-6">
            <label for="fee" class="col-sm-2 col-form-label">Status Bayar</label>
            <div class="col-sm-10">
        ...
        <div class="form-group row col-md-6">
            <label for="image" class="col-sm-2">Bukti Pembayaran</label>
            <div class="col-sm-10">
                <img type="image" readonly class="" id="image" src="{{ $cart->bukti_pembayaran }}" width="400px">
            </div>
        </div>
    </form>
