...
@section('container')
	...
	<div class="container-fluid">
		<h2 style="padding:4px; margin-bottom: (spacer * .25) !important;">Data Admin</h2>
		...
		<table class="table table-striped table-bordered table-hover text-center">
			...
			<tr>
					...
					<td style="width:500px">
						<form action="{{ route('admin.destroy', $usr->IDUser) }}" method="POST" class="d-inline">
							<a class="btn btn-info mx-1" href="{{ route('admin.show', $usr->IDUser) }}">Show</a>						
							@csrf
							@method('DELETE')
